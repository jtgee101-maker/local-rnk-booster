...
import { CheckCircle2, AlertCircle, Wrench, Star, Award } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(600px,90vw)] h-[min(600px,90vw)] bg-red-500/20 rounded-full blur-[80px] md:blur-[150px]" />
