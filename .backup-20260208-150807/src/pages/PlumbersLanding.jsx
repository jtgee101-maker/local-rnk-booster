...
export default function PlumbersLanding() {
  React.useEffect(() => {
    Promise.resolve(base44.analytics.track({ eventName: 'plumbers_landing_viewed' })).catch(() => {});
  }, []);

  const handleCTA = () => {
    Promise.resolve(base44.analytics.track({ eventName: 'plumbers_landing_cta_clicked' })).catch(() => {});
