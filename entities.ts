/**
 * @entity Tenant
 * @description Core white-label tenant data
 */
...
/**
 * @entity TenantUser
 * @description User membership in tenant
 */
...
/**
 * @entity UTMSession
 * @description Attribution tracking (Ghost Tracker)
 */
 ...
 * @description Tenant monitoring metrics
 */
