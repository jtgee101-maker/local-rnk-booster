...
import { CheckCircle2, AlertCircle, Zap, Star, Phone } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(600px,90vw)] h-[min(600px,90vw)] bg-yellow-500/20 rounded-full blur-[80px] md:blur-[150px]" />
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#c8ff00] to-yellow-500 rounded-3xl p-6 md:p-12 text-center"
        >
